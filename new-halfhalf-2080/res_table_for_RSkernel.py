...
def add_features(K, H, C, S, Stride, Tk, Th, Tw, Bk, Bh, Bw, CMult, alt, machine_info):
    ...
    # elif alt == 2:
    #     return [K, H, C, S, Stride, Tk, Th, Tw, Bk, Bh, Bw, CMult, Ops, G2S_trans, S2R_trans, S2G_trans, R2S_trans, G2R_kernel, recp_occupancy, correct_wave, conc_tb]
...
def expand_csv(file, alt, stride, if_train, if_norm, pass_norm_factor, machine_info):
    ...
    #     new_header = "K, H, C, S, Stride, Tk, Th, Tw, Bk, Bh, Bw, CMult, Ops, G2S_trans, S2R_trans, S2G_trans, R2S_trans, G2R_kernel, recp_occupancy, correct_wave, conc_tb, Time"
    elif alt == 2:  # problem sizes, stride, tile sizes, OPs, GM-transactions, SM-transactions,
...
def RS3(dirpath, machine_info,  topN, step, initN, all_model_dict, algo_list, algo_name):
    ...
    # summary_file = open("rs_c_summary3.csv", "w")
